...
export class GenericHMDevice extends FactoryDevice {
  ...
  constructor(
    ...
    public readonly conn: CCUConnectionInfo,
    ...
    const controllerMeta = this.meta.add({
      id: "hc-controller",
      key: `${H_SMARTHOME_NS_V1}/controller`,
      value: "hm2homie",
      subkeys: [
        {
          id: "hm-device-type",
          key: `${H_SMARTHOME_NS_V1}/hm-device-type`,
          value: device.definition.TYPE,
        },
        {
          id: "hm-device-fw",
          key: `${H_SMARTHOME_NS_V1}/hm-device-fw`,
          value: device.definition.FIRMWARE,
        },
        {
          id: "hm-protocol",
          key: `${H_SMARTHOME_NS_V1}/hm-protocol`,
          value: conn.protocol,
        },
      ],
    });
  ...
  public async create() {
    ...
    this.specificNodeCreated = createNodesForDevice(
      this,
      this.device,
      this.conn,
    );
    ...
    if (!this.specificNodeCreated) {
      this.log.info(
        `no specific smarthome nodes created for ${this.device.name}|${this.device.definition.ADDRESS}. Will generate generic ones.`,
      );
